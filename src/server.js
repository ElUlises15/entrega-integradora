...
mongoose.connect(
  "mongodb+srv://ulises110103:coder-pass@codercluster.pb4dvno.mongodb.net/?retryWrites=true&w=majority&appName=CoderCluster",
...
io.on("connection", (socket) => {
  ...
  socket.on("sendMessage", (messageData) => {
    ...
    console.log(
      `Nuevo mensaje recibido: ${messageData.message} (Usuario: ${messageData.user})`
    );
